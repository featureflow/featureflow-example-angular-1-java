...
import io.featureflow.example.repository.ClientRepository;
import io.featureflow.example.service.ClientService;
import io.featureflow.example.service.dto.ClientDTO;
import io.featureflow.example.service.mapper.ClientMapper;
...
public class ClientResourceIntTest {
    ...
    private static final Tier DEFAULT_TIER = Tier.GOLD;
    private static final Tier UPDATED_TIER = Tier.SILVER;
